...
| `pieces/cathedral.py` | [i'm building a cathedral one video at a time.](https://youtube.com/watch?v=qsMw5ckmGsA) — **a serial, part I of however many.** The finished building exists from the first episode as a line drawing; parts move from ghost to stone as they are built, and the camera is fitted to the finished cathedral and never moves, so any two episodes can be overlaid. Part I cuts 341 m of trench and sets 53 footings at 6.4 m spacing |
